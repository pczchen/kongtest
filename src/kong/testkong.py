...
from kong.httpreq import mybasic as basic_req
from kong.httpreq import mykey   as key_req
from kong.httpreq import myhmac  as hmac_req
from kong.httpreq import myoauth2 as oauth2_req
